...
meta.undiagnosed<-read.delim("/Volumes/DDD_meh/Analysis/Exome/For_1133_trio_ms/Meta_DD_undiagnosed/Mup-it_Daly_020514_META_undiagnosed.output.combined.txt", header=T)
